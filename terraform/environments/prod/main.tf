...
module "iam_user"{
    ...
    user_name = "jeff-ndegwa-254-prod-user"
}

module "lambda_function"{
    source = "../../modules/lambda"
    lambda_function_name = "jeff-ndegwa-254-prod-lambda-function"
    lambda_invoke_role_name = "jeff-ndegwa-254-prod-lambda-invoke-role"
}
